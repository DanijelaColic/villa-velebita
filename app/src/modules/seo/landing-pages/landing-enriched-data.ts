...
export const LANDING_ENRICHED: LandingEnrichedMap = {
  "smjestaj-plitvicka-jezera": {
    hr: {
      eyebrow: "Plitvice i Lika",
      heroImage: {
        src: "/images/seo/landing/plitvicka_jezera.png",
        alt: "Ilustrativni prikaz jezera i slapova — podsjetnik na NP Plitvička jezera (placeholder).",
      },
      highlights: [
        "Raniji dolazak u park i više vremena za uživanje u prirodi",
        "Privatni jacuzzi nakon šetnji i obilaska parka",
        "Direktna rezervacija uz jasnu komunikaciju",
      ],
      sections: [
        {
          heading: "Zašto smještaj u Lici ima smisla uz posjet Plitvicama",
          paragraphs: [
            "Ako za smještaj birate kuću Villa Velebita, lakše držite vlastiti ritam: jutarnji odlazak na jezera, popodnevni odmor, a navečer mir u okolišu.",
            "Villa Velebita naglašava prirodu, prostor za obitelj ili manju grupu te jednostavno povezivanje aktivnosti tijekom cijelog boravka.",
          ],
        },
        {
          heading: "Kombinacija aktivnog dana i opuštene večeri",
          paragraphs: [
            "Plitvička jezera najbolje doživljavate uz dovoljno vremena za pauze i kratke alternative u okolici.",
            "Jacuzzi i privatnost kuće pomažu da se tijelo i glava uspore nakon kretanja po stazama i vidikovcima.",
          ],
        },
        {
          heading: "Obitelji, parovi i manje grupe",
          paragraphs: [
            "Raspored možete složiti fleksibilno: jedan glavni izlet ujutro, laganije popodne, bez žurbe oko parkiranja i povratka.",
            "Za veće grupe pogledajte i stranicu za smještaj do devet osoba kako biste uskladili kapacitet i udobnost.",
          ],
        },
      ],
      activitiesSectionTitle: "Aktivnosti i atrakcije u blizini",
      activities: [
        {
          title: "NP Plitvička jezera",
          description:
            "Šetnje uz jezera i drvene staze kroz prirodu NP Plitvička jezera.",
          image: "/images/seo/landing/family_walking.jpg",
          imageAlt: "Placeholder vizual jezera i slapova.",
        },
        {
          title: "Vidikovci i šetnje u Lici",
          description:
            "Kraće rute i mirniji kutak prirode za dan kad želite manje gužve.",
          image: "/images/seo/landing/vidikovci.png",
          imageAlt: "Placeholder brdski krajolik Like.",
        },
        {
          title: "Lokalni izleti i miran tempo",
          description:
            "Poludnevni planovi uz gastronomiju i odmor — dobar balans uz posjet parku.",
          image: "/images/seo/landing/hrana.png",
          imageAlt: "Placeholder šetnje prirodom.",
        },
        {
          title: "Odmor uz kuću",
          description:
            "Terasa, jacuzzi i privatni prostor nakon aktivnog dijela dana.",
          image: "/images/seo/landing/odmor_u_kuci.png",
          imageAlt: "Placeholder vanjskog prostora smještaja.",
        },
      ],
      midCtaTitle: "Želite termin koji vama odgovara?",
      midCtaBody:
        "Pregledajte dostupnost i cjenik, zatim rezervirajte direktno — brže dogovaranje detalja i bez provizija platformi.",
      midCtaPrimaryLabel: "Rezervacija",
      midCtaGalleryLabel: "Galerija",
      faqSectionTitle: "Često postavljana pitanja",
      faqs: [
        {
          question: "Koliko je daleko do ulaza u park?",
          answer:
            "Udaljenost ovisi o odabranom ulazu i sezoni; smještaj u Lici obično znači kratku vožnju do područja Plitvica, 30ak minuta autom. Točan put i vrijeme dogovorite prije dolaska.",
        },
        {
          question: "Je li jacuzzi dostupan cijelu godinu?",
          answer:
            "Jacuzzi se nalazi na terasi kuće i dio je jedinstvenog iskustva boravka; korištenje ovisi o vremenu i vašim preferencijama.",
        },
        {
          question: "Mogu li rezervirati direktno?",
          answer:
            "Da — direktna rezervacija kroz stranicu smanjuje posrednike i olakšava komunikaciju oko dolaska i plaćanja.",
        },
        {
          question: "Za koga je smještaj najprikladniji?",
          answer:
            "Za parove, obitelji i manje grupe koje traže mir, privatnost i dobru logistiku oko izleta.",
        },
        {
          question: "Kako planirati dan u parku?",
          answer:
            "Raniji polazak i jednostavniji raspored obično donose ugodniji doživljaj; kombinirajte obilazak Plitvičkih jezera s odmorom na terasi kuće navečer.",
        },
      ],
      reservationIntro:
        "Pregledajte cijene, dostupnost i lokaciju prije rezervacije kako bi plan putovanja bio jednostavan i bez iznenađenja.",
      guidesBlockTitle: "Vodiči za Plitvice i Liku",
      guidesBlockIntro:
  ...
  "kuca-za-odmor-plitvice": {
    hr: {
      eyebrow: "Kuća za odmor",
      heroImage: {
        src: "/images/seo/landing/jacuzzi.png",
        alt: "Ilustracija vanjskog prostora kuće za odmor (placeholder).",
      },
      highlights: [
        "Cijeli objekt samo za vašu skupinu — bez dijeljenja s drugim gostima",
        "Prostor za zajedničko druženje i mirne večeri nakon izleta",
        "Direktna rezervacija uz jasne uvjete boravka",
      ],
      sections: [
        {
          heading: "Kuća za odmor kao baza za Plitvice i Liku",
          paragraphs: [
            "Kad rezervirate cijelu kuću, lakše je uskladiti obiteljske rutine, vrijeme za kavu i polazak na staze bez “hotelskog” ritma.",
            "Lika nudi mir, zvijezde navečer i kratke vožnje prema glavnim prirodnim atrakcijama — idealno za višednevni odmor.",
          ],
        },
        {
          heading: "Obitelji i grupe prijatelja",
          paragraphs: [
            "Zajednički boravak traži dovoljno mjesta za prtljagu, igru djece i opuštanje odraslih.",
            "Nakon aktivnog dana, mirna večer uz kuću pomaže da se dan lijepo završi — posebno ako planirate druženje uz roštilj, jacuzzi ili samo čašu vina na terasi.",
          ],
        },
        {
          heading: "Logistika putovanja",
          paragraphs: [
            "Raniji dolazak ili kasniji odlazak jednostavnije funkcioniraju kad imate privatni smještaj i fleksibilnu komunikaciju s domaćinom.",
            "Pripremite sezonu obuće, lagane slojeve i plan za kišu — u prirodi oko Plitvica vrijeme zna promijeniti tempo dana.",
          ],
        },
      ],
      activitiesSectionTitle: "Što raditi tijekom boravka",
      activities: [
        {
          title: "NP Plitvička jezera",
          description:
            "Glavni razlog putovanja: slapovi, staze i boje vode kroz godišnja doba.",
          image: "/images/seo/landing/plitvice.jpg",
          imageAlt: "Placeholder jezera.",
        },
        {
          title: "Šetnje i vidikovci u okolici",
          description: "Blage rute kad želite manje ljudi i više zraka.",
          image: "/images/seo/landing/vidikovci.png",
          imageAlt: "Placeholder Like.",
        },
        {
          title: "Obiteljske igre i odmor uz kuću",
          description:
            "Board game večer, roštilj ili tiha knjiga — dan bez vožnje.",
          image: "/images/seo/landing/hrana.png",
          imageAlt: "Placeholder obitelji u prirodi.",
        },
        {
          title: "Aktivniji izlet",
          description:
            "Duža šetnja, zipp line ili quard tura ako ste u formi.",
          image: "/images/seo/landing/zip-line.jpg",
          imageAlt: "Placeholder planinarenja.",
        },
      ],
      midCtaTitle: "Trebate cijelu kuću za svoj datum?",
      midCtaBody:
        "Provjerite kapacitet i cjenik, pošaljite upit za termin i dogovorite detalje dolaska direktno — bez provizija.",
      midCtaPrimaryLabel: "Rezervacija",
      midCtaGalleryLabel: "Galerija",
      faqSectionTitle: "Česta pitanja",
      faqs: [
        {
          question: "Je li kuća isključivo za nas?",
          answer:
            "Smještaj je koncipiran kao privatna kuća za odmor za jednu skupinu gostiju — bez dijeljenja s drugima.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Često su dva ili tri dana optimalna za miran tempo uz posjet parku i okolici.",
        },
      ],
      reservationIntro:
        "Pregledajte cijene, dostupnost i lokaciju prije rezervacije kako bi plan putovanja bio jednostavan i bez iznenađenja.",
  ...
  "villa-jacuzzi-plitvice": {
    hr: {
      eyebrow: "Jacuzzi i mir",
      heroImage: {
        src: "/images/seo/landing/odmor_u_kuci.png",
        alt: "Ilustracija opuštanja u jacuzziju (placeholder).",
      },
      highlights: [
        "Privatni vanjski jacuzzi za goste smještaja",
        "Idealno nakon šetnji, slapova i cjelodnevnih izleta",
        "Kombinacija Like i blizine Plitvica",
      ],
      sections: [
        {
          heading: "Zašto jacuzzi čini razliku nakon parka",
          paragraphs: [
            "Plitvička jezera ostavljaju trag kretanja, stepenica i stalnog otkrivanja — navečer tijelo traži toplinu i mir.",
            "Privatni jacuzzi u okviru boravka daje osjećaj “male wellness pauze” bez odlaska u spa centar.",
          ],
        },
        {
          heading: "Romantični odmor i obiteljski rituali",
          paragraphs: [
            "Parovima jacuzzi bude večernji ritual nakon večere; obiteljima mjesto za smijeh i lagani razgovor pod zvijezdama.",
            "Lika nudi tišu noćnu pozadinu — bez gradske buke — što pojačava dojam odmora.",
          ],
        },
        {
          heading: "Sezonski ritam i realna očekivanja",
          paragraphs: [
            "Korištenje vanjskog jacuzzija ovisi o vremenu i osobnim preferencijama; uvijek pitajte prilikom rezervacije.",
            "Uz jacuzzi i dalje vrijedi planirati dobru obuću, lagane jakne i rezervu vremena za park.",
          ],
        },
      ],
      activitiesSectionTitle: "Aktivnosti koje se lijepo spajaju s jacuzzijem",
      activities: [
        {
          title: "NP Plitvička jezera",
          description:
            "Aktivan dio dana: slapovi, staze, fotografije i mirna pauza uz vodu.",
          image: "/images/seo/landing/panoramski_vlak.jpg",
          imageAlt: "Placeholder jezera.",
        },
        {
          title: "Lagane šetnje i zrak Like",
          description:
            "Manji intenzitet kako biste navečer uživali u toploj kupki.",
          image: "/images/seo/landing/voznja_brodom_na_plitvicama.jpg",
          imageAlt: "Placeholder brda.",
        },
        {
          title: "Wellness večer uz kuću",
          description:
            "Lagana večera, čaj i jacuzzi — jednostavan “spa” dan bez satnice.",
          image: "/images/seo/landing/odmor_u_kuci.png",
          imageAlt: "Placeholder jacuzzi.",
        },
        {
          title: "Obiteljski odmor",
          description:
            "Djeca na svježem zraku, odrasli na opuštanju — balans kojeg često traže gosti.",
          image: "/images/seo/landing/family_farm_2.jpg",
          imageAlt: "Placeholder obitelji.",
        },
      ],
      midCtaTitle: "Želite jacuzzi iskustvo uz termin boravka?",
      midCtaBody:
        "Provjerite dostupnost, pogledajte galeriju i rezervirajte direktno kako biste uskladili jacuzzi s ostatkom putovanja.",
      midCtaPrimaryLabel: "Provjeri termine",
      midCtaGalleryLabel: "Galerija",
      faqSectionTitle: "Česta pitanja o jacuzziju",
      faqs: [
        {
          question: "Je li jacuzzi zaista privatan?",
          answer:
            "Namijenjen je isključivo gostima smještaja, bez dijeljenja s javnošću ili drugim najmima.",
        },
        {
          question: "Radi li se o unutarnjem ili vanjskom jacuzziju?",
          answer:
            "U ponudi je vanjski jacuzzi kao dio iskustva boravka; detalje provjerite pri upitu.",
        },
        {
          question: "Mogu li ga koristiti nakon kiše?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Ujutro park ili šetnja, popodne odmor, navečer jacuzzi — jednostavan i održiv raspored.",
        },
      ],
      reservationIntro:
        "Pregledajte cijene, dostupnost i lokaciju prije rezervacije kako bi plan putovanja bio jednostavan i bez iznenađenja.",
  ...
  "smjestaj-za-9-osoba-plitvice": {
    hr: {
      eyebrow: "Grupa do 9 osoba",
      heroImage: {
        src: "/images/seo/landing/odmor_u_kuci.png",
        alt: "Ilustracija obitelji i prijatelja u prirodi (placeholder).",
      },
      highlights: [
        "Smještaj za veće obitelji i grupe prijatelja",
        "Prostor za zajedničke obroke i dogovor oko aktivnosti",
        "Blizina Plitvica radi jednostavnije logistike",
      ],
      sections: [
        {
          heading: "Kad putuje devet osoba, logistika je polovica doživljaja",
          paragraphs: [
            "Zajednički odmor traži jasne uloge: tko vozi, tko kuha, kada je polazak u NP Plitvička jezera.",
            "Privatna kuća kao glavno mjesto smanjuje nesuglasice oko rasporeda i daje jedno mjesto za “sastanak” grupe navečer.",
          ],
        },
        {
          heading: "Kako isplanirati budžet i termin",
          paragraphs: [
            "Podijelite troškove unaprijed i dogovorite minimalni broj noćenja kako bi sve bilo fer.",
            "Ranija rezervacija pomaže u usklađivanju datuma i izbjegava žurbu zadnjeg trenutka.",
          ],
        },
        {
          heading: "Aktivnosti koje funkcioniraju za veće skupine",
          paragraphs: [
            "NP Plitvice moguće je posjetiti u manjim podskupinama ili zajedno, ovisno o tempu.",
            "Ugradite barem jedan “spori dan” bez vožnje — grupa će vam biti zahvalna.",
          ],
        },
      ],
      activitiesSectionTitle: "Ideje za grupni raspored",
      activities: [
        {
          title: "NP Plitvička jezera",
          description:
            "Dogovorite ulaz, pauze i mjesto okupljanja nakon šetnje.",
          image: "/images/seo/landing/plitvicka_jezera.png",
          imageAlt: "Placeholder jezera.",
        },
        {
          title: "Izlet u Lici",
          description: "Kraći izlet kad dio grupe želi mirniji tempo.",
          image: "/images/seo/landing/bariceve_spilje.jpg",
          imageAlt: "Placeholder Like.",
        },
        {
          title: "Večera i druženje uz smještaj",
          description:
            "Zajednička večera je često najbolji “team building” na odmoru.",
          image: "/images/seo/landing/hrana.png",
      ...
      midCtaTitle: "Treba vam smještaj za devet osoba?",
      midCtaBody:
        "Pošaljite upit s datumima, provjerite cjenik i uskladite kapacitet soba s potrebama grupe — direktno i transparentno.",
      midCtaPrimaryLabel: "Pošalji upit",
      midCtaGalleryLabel: "Galerija",
      faqSectionTitle: "FAQ za grupe",
      faqs: [
        {
        ...
        },
        {
          ...
          answer:
            "Dogovorite fiksni iznos po osobi ili po obiteljskoj jedinici prije puta kako biste izbjegli nesporazume.",
        },
        {
          question: "Mogu li djeca i odrasli zajedno?",
          answer:
            "Da, ali unaprijed provjerite raspored prostora kako bi djeca imala miran kutak za spavanje.",
        },
        {
          question: "Kako planirati Plitvice u grupi?",
          answer:
