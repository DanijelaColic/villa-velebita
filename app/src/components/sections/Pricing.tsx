  ...
  return (
    <SectionWrapper id="cijene" bg="oak">
        ...
        <div className="lg:col-span-2 bg-cream rounded-card p-8 shadow-warm">
          <div className="flex flex-wrap items-start justify-between gap-6 mb-8">
            <div>
              ...
              <p className="text-stone text-sm mt-1">Cijela kuća · do 9 osoba</p>
            </div>
      ...
      <p className="mt-6 text-center text-xs text-stone-light">
        Cijene su iskazane u eurima. Minimalni boravak 3 noći. Popust od 10% za rezervacije 7 i više noći.
        Za posebne zahtjeve (dječji krevetić, kućni ljubimci) javite se unaprijed.
      </p>
    </SectionWrapper>
  );
}
