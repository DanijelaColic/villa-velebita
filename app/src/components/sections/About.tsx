...
const highlights = [
  ...
  },
  {
    ...
    title: 'Rustikalna pečenjara',
    desc: 'Vanjska pečenjara za janjetinu, roštilj i nezaboravne večere uz vatru.',
  },
];
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div>
          ...
          <div className="space-y-5 text-stone text-base md:text-lg leading-relaxed">
            ...
            <p>
            Navečer, pod zvjezdanim ličkim nebom, opustite se u vanjskom jacuzziju, 
            a u rustikalnoj pečenjari pripremite sve – od janjeta do roštilja. 
            Trenuci koji se pamte godinama.
            </p>
          </div>
